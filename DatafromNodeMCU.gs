...
var SS = SpreadsheetApp.openById('1sefKprx_3mSOuZioCNjCdX6aw5FNFic5QSHT1o_n2o4');
var timezone = "GMT+5:30"; // Indian Standard Time
var hours = 0;
var str = "";
...
function doPost(e) {
  ...
  if (parsedData !== undefined){
    ...
    var Curr_Date = Utilities.formatDate(new Date(), timezone, "MM/dd/yyyy"); // gets the current date in IST
    var Curr_Time = Utilities.formatDate(new Date(), timezone, "hh:mm:ss a"); // gets the current time in IST
    ...
    switch (parsedData.command) {
      case "insert_row":
         ...
         sheet.getRange('J2').setValue(value1+"_"+value0+"@iitp.ac.in");     // publish ADDRESS cell I2
         str = "Success"; // string to return back to Arduino serial console
